...
// BerryRavindran tìm kiếm chuỗi con bằng thuật toán Berry-Ravindran
...
func BerryRavindran(source, target string) (exist bool, index int) {
	// TODO: Implement Berry-Ravindran algorithm
	return exist, index
}
