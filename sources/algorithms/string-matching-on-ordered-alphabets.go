...
// StringMatchingOnOrderedAlphabets tìm kiếm chuỗi con bằng thuật toán String Matching on Ordered Alphabets
...
func StringMatchingOnOrderedAlphabets(source, target string) (exist bool, index int) {
	// TODO: Implement String Matching on Ordered Alphabets algorithm
	return exist, index
}
