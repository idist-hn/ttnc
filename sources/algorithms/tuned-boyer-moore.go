...
// TunedBoyerMoore tìm kiếm chuỗi con bằng thuật toán Tuned Boyer-Moore
...
func TunedBoyerMoore(source, target string) (exist bool, index int) {
	// TODO: Implement Tuned Boyer-Moore algorithm
	return exist, index
}
