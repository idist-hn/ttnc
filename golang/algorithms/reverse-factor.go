...
// ReverseFactor tìm kiếm chuỗi con bằng thuật toán Reverse Factor
...
func ReverseFactor(source, target string) (exist bool, index int) {
	// TODO: Implement Reverse Factor algorithm
	return exist, index
}
