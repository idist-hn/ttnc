...
// SkipSearch tìm kiếm chuỗi con bằng thuật toán Skip Search
...
// Bảng skip được tính dựa trên vị trí cuối cùng của mỗi ký tự trong pattern
func SkipSearch(source, target string) (exist bool, index int) {
	exist = false
	index = -1
