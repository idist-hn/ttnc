/**
 * TurboBM - Thuật toán tìm kiếm chuỗi con bằng Turbo BM
 * 
...
class TurboBM {
    /**
     * Tìm kiếm chuỗi con bằng thuật toán Turbo BM
     * 
    ...
    static search(source, target) {
        ...
        let i = 0;
        let turboShift = 0; // Turbo shift: số ký tự đã khớp từ lần trước
