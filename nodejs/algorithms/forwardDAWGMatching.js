/**
 * ForwardDAWGMatching - Thuật toán tìm kiếm chuỗi con bằng Forward DAWG Matching
 * 
 * Độ phức tạp thời gian: O(n+m)
 * Độ phức tạp không gian: O(m)
 * 
 * Forward DAWG Matching sử dụng Directed Acyclic Word Graph
 * để tối ưu hóa tìm kiếm chuỗi con
 */

class ForwardDAWGMatching {
...
module.exports = ForwardDAWGMatching;
